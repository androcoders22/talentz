  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-8 md:right-8 z-50 flex items-center bg-zinc-950/80 backdrop-blur-xl border border-white/10 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.4)] pointer-events-auto transition-all duration-300 hover:bg-zinc-900 hover:border-white/20 hover:shadow-[0_8px_32px_rgba(0,0,0,0.6)]">
      ...
      <Link
        ...
        target="_blank"
        className="group flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-l-full bg-transparent hover:bg-[#25D366]/10 transition-colors duration-300"
        title="WhatsApp Us"
      >
        <IconBrandWhatsapp
      ...
      <Link
        href="#contact-us"
        className="group flex items-center justify-center w-12 h-12 md:w-14 md:h-14 rounded-r-full bg-transparent hover:bg-white transition-colors duration-300"
        title="Contact Us"
      >
        <IconMail
